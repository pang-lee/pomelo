          ...
          <b-tabs content-class="mt-3" justified active-nav-item-class="font-weight-bold text-uppercase text-danger">
            <b-tab title="Login" active>
              <b-form @submit.stop.prevent="Login">
                ...
                <b-form-invalid-feedback :state="LoginEmailvalidation">Invalid Email Format.</b-form-invalid-feedback>
                <b-form-valid-feedback :state="LoginEmailvalidation">Looks Good.</b-form-valid-feedback>
                ...
                <b-form-invalid-feedback :state="LoginPasswordvalidation">At least three characters and digits. | Example: abc123</b-form-invalid-feedback>
                <b-form-valid-feedback :state="LoginPasswordvalidation">Looks Good.</b-form-valid-feedback>
            ...
            <b-tab title="SignUp">
              <b-form @submit.stop.prevent="SignUp">
                ...
                <b-form-invalid-feedback :state="SignUpEmailvalidation">Invalid Email Format.</b-form-invalid-feedback>
                <b-form-valid-feedback :state="SignUpEmailvalidation">Looks Good.</b-form-valid-feedback>
                ...
                <b-form-invalid-feedback :state="SignUpPasswordvalidation">At least three characters and digits. | Example: abc123</b-form-invalid-feedback>
                <b-form-valid-feedback :state="SignUpPasswordvalidation">Looks Good.</b-form-valid-feedback>
                ...
                <b-form-valid-feedback :state="Confirmvalidation">Looks Good.</b-form-valid-feedback>

                <br/>
                <b-form-group label="User Name:">
                  <b-form-input :state="Uservalidation" v-model="formSignUp.uname" required placeholder="Enter UserName"></b-form-input>
                </b-form-group>
                <b-form-invalid-feedback :state="Uservalidation">Choose any name you like.</b-form-invalid-feedback>
                <b-form-valid-feedback :state="Uservalidation">Looks Good.</b-form-valid-feedback>
